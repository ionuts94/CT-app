...
export const SignUpSchema = z.object({
    email: z.string().email("Adresa de email nu este validă").min(1, "Emailul este obligatoriu"),
    firstName: z.string().min(1, "Prenumele este obligatoriu"),
    lastName: z.string().min(1, "Prenumele este obligatoriu"),
    password: z.string().min(6, "Parola trebuie să aibă minim 6 caractere"),
    cPassword: z.string().min(6, "Confirmarea parolei este obligatorie"),
