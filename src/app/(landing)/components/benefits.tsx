    ...
    <div className="flex flex-col gap-[56px] items-center justify-center py-[110px] bg-slate-100">
      <LandingPageWidth className="flex flex-col">
        <SectionHeaderContainer>
          ...
          <SectionTitle>PDFs make signing feel like admin work.</SectionTitle>
          <SectionSubtitle className="max-w-[720px] text-center">
            The deal may be agreed, but every extra step gives clients another reason to delay.
          </SectionSubtitle>
        </SectionHeaderContainer>
      </LandingPageWidth>
      ...
      <LandingPageWidth className="flex flex-col gap-6">
        <div className="flex flex-col gap-2 text-center lg:text-left">
          <TextCTA className="text-[20px] leading-[28px] font-[700] uppercase text-[#0f172a]">
            Why signed contracts get stuck
          </TextCTA>
          <Text className="text-[16px] leading-[26px] text-[#475569]">
            A simple signature turns into work your client has to finish later.
          </Text>
        </div>
        ...
        <div className="rounded-lg border border-primary/15 bg-white px-5 py-4 shadow-sm">
          <Text className="text-[18px] leading-[30px] font-[500] text-[#334155]">
            The result: more follow-up emails, slower turnaround and deals left waiting after the client already said yes.
          </Text>
        </div>
      </LandingPageWidth>
    </div>
